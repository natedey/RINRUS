...
```
# required (only one of model or approx_model_size_limit required, approx_model_size_limit overrides model)
...
approx_model_size_limit:   approx desired number of atoms
